...
contract CampignFactory {
    ...
    function deployContract(uint256 minAmount) public payable {
        address newCampaign = address(new Campign(minAmount, msg.sender));
        campains.push(newCampaign);
    }
}
...
contract Campign {
    ...
    function finalizeRequest(uint256 index) public restricted {
        ...
        require(request.approvalCount > contributors / 2);
